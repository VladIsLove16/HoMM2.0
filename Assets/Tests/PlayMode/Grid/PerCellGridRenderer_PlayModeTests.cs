...
//        public sealed class TestGridViewModel : IGridViewModel
//        {
...
//            public IGridRenderSettings RenderSettings { get; } = new TestGridRenderSettings();
//            public int Width { get ; set; }
//            public int Height { get; set; }

//            private IWorldToCellProvider _provider = new TestWorldToCellProvider();

//            public void RaisePreview(PreviewResult result) => PreviewChanged?.Invoke(result);
//            public void RegisterWorldProvider(IWorldToCellProvider provider)
//            {
//                if (provider != null)
//                {
//                    _provider = provider;
...
//            public Vector3 ToWorld(int x, int y) => _provider.ToWorld(x, y);

//            public bool ToGrid(Vector3 position, out Vector2Int coords) => _provider.ToGrid(position, out coords);

//            public bool ToGridPair(Vector3 position, out KeyValuePair<Vector2Int, Vector2Int> coords) =>
//                _provider.ToGridPair(position, out coords);
//        }
//    }
//}
