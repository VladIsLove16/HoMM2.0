...
namespace Assets.Scripts.Adventure.Infrastructure.Input
{
    ...
    public sealed class AdventurePlayerInput : MonoBehaviour, IDisposable
    {
        ...
        private void Awake()
        {
            ...
            _playerMap.Enable();
            _moveAction = _playerMap.Player.Move;
            _lookAction = _playerMap.Player.Look;
            _sprintAction = _playerMap.Player.Sprint;
            _interactAction = _playerMap.Player.Interact;
            _showHintAction = _playerMap.Player.ShowHint;
