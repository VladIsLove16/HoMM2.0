...
namespace Tests.EditMode.GridContents.Units
{
    ...
    public class UnitModelEdgeCaseTests
    {
        ...
        {
            // Act & Assert
            Assert.Throws<ArgumentNullException>(() => _unitModel.ApplyStatusEffect(null));
        }
        ...
        {
            // Arrange
            var nonExistentEffect = new MockStatusEffect(StatusEffectType.Poison);
        ...
        {
            // Arrange
            var effect1 = new MockStatusEffect(StatusEffectType.Poison);
            var effect2 = new MockStatusEffect(StatusEffectType.Stun);
            _unitModel.ApplyStatusEffect(effect1);
            _unitModel.ApplyStatusEffect(effect2);
