...
namespace Tests.EditMode.GridContents.Units
{
    ...
    public class UnitViewModelTests
    {
        ...
        private UnitViewModelMaterialsInfo _materialsInfo;
        ...
        public void SetUp()
        {
            ...
            _materialsInfo = new UnitViewModelMaterialsInfo(new MockUnitDefinitionSO());

            // Создаем мок провайдера
            _worldToCellProvider = new MockWorldToCellProvider();

            // Создаем ViewModel
            _unitViewModel = new UnitViewModel(_unitModel, _materialsInfo);
        ...
        public void Constructor_WithBlueTeamUnit_SetsBlueTeamMaterials()
        {
            ...
            var blueTeamViewModel = new UnitViewModel(blueTeamModel, _materialsInfo);

            // Assert
            Assert.That(blueTeamViewModel.TeamMaterial, Is.EqualTo(_materialsInfo.BlueTeamMaterial));
            Assert.That(blueTeamViewModel.HoveredTeamMaterial, Is.EqualTo(_materialsInfo.HoveredBlueTeamMaterial));
        }
        ...
        public void Constructor_WithRedTeamUnit_SetsRedTeamMaterials()
        {
            ...
            var redTeamViewModel = new UnitViewModel(redTeamModel, _materialsInfo);

            // Assert
            Assert.That(redTeamViewModel.TeamMaterial, Is.EqualTo(_materialsInfo.RedTeamMaterial));
            Assert.That(redTeamViewModel.HoveredTeamMaterial, Is.EqualTo(_materialsInfo.HoveredRedTeamMaterial));
        }
