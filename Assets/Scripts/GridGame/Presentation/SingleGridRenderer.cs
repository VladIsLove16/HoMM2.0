...
//public class SingleGridRenderer : IGridCellRenderer, IWorldToCellProvider
//{
...
//    {
//        Vector3 origin = singleObject != null ? singleObject.transform.position : Vector3.zero;
...
//    {
//        Bind((IGridViewModel)viewModel);
//    }

//    public void Unbind(GameViewModel viewModel)
//    {
//        Unbind((IGridViewModel)viewModel);
//    }

//    public void Bind(IGridViewModel gameViewModel)
//    {
//        gameViewModel?.RegisterWorldProvider(this);
//    }
