...
//using UnityEngine;
////IBlockable, IEffectableLegacy, IAttackable,
//public class UnitModelLegacy : IGridContent,  IDamageSource, IDamageable, IEffectableLegacy, IEffectApplierLegacy, ICombatUnit
//{
...
//    public UnitModelLegacy(UnitDefinitionSO unitDefinitionSO, int x,int y, int amount, bool isPlayer)
//    {
...
//            StatusEffectManager.Apply(statusEffect);
//        }
//        this.x = x;
//        this.y = y;
//        Amount = amount;
