...
public class GameGridUIPanelView : MonoBehaviour
{
    ...
    [Inject]
    public void Construct(GameViewModel viewModel, GameController gameController, IGameCommandExecutor gameCommandExecutor)
    {
        this.viewModel = viewModel;
        this.gameController = gameController;

        Create.onClick.AddListener(() => gameController.CreateGridContent());
        RunBattle.onClick.AddListener(()=> gameCommandExecutor.StartBattle());
