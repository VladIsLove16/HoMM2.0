...
//     version 1.11.2
//     from Assets/Scripts/Input/InputSystem_Actions/InputSystem_GridGame.inputactions
//
...
public partial class @InputSystem_GridGame: IInputActionCollection2, IDisposable
{
    ...
    ~@InputSystem_GridGame()
    {
        ...
        UnityEngine.Debug.Assert(!m_Console.enabled, "This will cause a leak and performance issues, InputSystem_GridGame.Console.Disable() has not been called.");
    }
    ...
    {
        private @InputSystem_GridGame m_Wrapper;
        public ConsoleActions(@InputSystem_GridGame wrapper) { m_Wrapper = wrapper; }
